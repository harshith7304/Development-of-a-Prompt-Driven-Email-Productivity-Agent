...
An intelligent, prompt-driven email agent capable of processing an inbox, categorizing emails, extracting action items, and auto-drafting replies using LLMs (Groq/Llama 3).

## Features

- **Email Ingestion**: Loads a mock inbox with various email types.
